...
//--METODO DE CLASE
	...
	$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into pedidos (tipo,ingredientes,precio,cantidad,nombre,longitud,latitud,id_local)values(:tipo,:ingredientes,:precio,:cantidad,:nombre,:longitud,:latitud,:id_local)");
		...
		$consulta->bindValue(':longitud', $Pedidos->longitud, PDO::PARAM_STR);
		$consulta->bindValue(':latitud', $Pedidos->latitud, PDO::PARAM_STR);
